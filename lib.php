...
/**
 * Razorpay enrolment plugin implementation.
 * 
 * @package    enrol_razorpaypayment
 * @author     Erudisiya <contact.erudisiya@gmail.com>
 * @copyright  2024 Erudisiya Team(https://erudisiya.com)
...
class enrol_razorpaypayment_plugin extends enrol_plugin {
    ...
    public function get_currencies() {
        // See https://www.razorpay.com/cgi-bin/webscr?cmd=p/sell/mc/mc_intro-outside,
        // 3-character ISO-4217: https://cms.razorpay.com/us/cgi-bin/?cmd=
     ...
     */
    public function get_razorpay_amount($cost, $currency, $reverse) {
    ...
    */
    ...
    public function add_course_navigation($instancesnode, stdClass $instance) {
        ...
        if (has_capability('enrol/razorpaypayment:config', $context)) {
            $managelink = new moodle_url('/enrol/razorpaypayment/edit.php',
    ...
    public function get_action_icons(stdClass $instance) {
        ...
        $icons = array();
        if (has_capability('enrol/razorpaypayment:config', $context)) {
            $editlink = new moodle_url("/enrol/razorpaypayment/edit.php",
            array('courseid' => $instance->courseid, 'id' => $instance->id));
    ...
    public function enrol_page_hook(stdClass $instance) {
        ...
        // } else {
            ...
            if (isguestuser()) { // Force login only for guest user, not real users with guest role.
                ...
                include($CFG->dirroot.'/enrol/razorpaypayment/enrol.php');
            }
        //}
        return $OUTPUT->box(ob_get_clean());
    }
    /**
     * Creates can razorpaypayment enrol.
     *
     * @param stdClass $instance
     * @return string html text, usually a form in a text box
     */
...
class admin_enrol_razorpaypayment_configtext extends admin_setting_configtext {
    public function write_setting($data) {
        if ($this->name == 'webservice_token' && $data == '') {
            return get_string('token_empty_error', 'enrol_razorpaypayment');
        }
