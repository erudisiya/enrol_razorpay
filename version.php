...
$plugin->version   = 2024041405;        // The current plugin version (Date: YYYYMMDDXX).
$plugin->requires  = 2020061500;        // Requires this Moodle version.
$plugin->component = 'enrol_razorpaypayment';    // Full name of the plugin (used for diagnostics).
