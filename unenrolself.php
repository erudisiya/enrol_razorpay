...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'razorpaypayment'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/razorpaypayment/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_razorpaypayment', format_string($course->fullname));
